...
# Pathfinding algorithms and shared navigation state
from agent.pathfinding import (
    _pathfind_to_target, _local_pathfind_from_tiles,
    _astar_pathfind_to_coords_with_grid, _astar_pathfind_with_grid_data,
    _truncate_path_at_warp, pathfind_to_goal,
    _dynamically_blocked_tiles, _recent_positions,
    _DIRECTION_OFFSETS, MAX_MOVEMENT_BATCH_SIZE,
)
# Stuck detection, warp handling, and post-dialogue limiting
from agent import stuck_handler
# VLM response parsing
from agent.vlm_action import parse_vlm_response, VALID_BUTTONS
            ...
            if directive:
                ...
                if 'goal_coords' in directive:
                    ...
                    if distance > 0:
                        ...
                        # Use unified pathfinding helper (local A* → global A*)
                ...
                # Handle NAVIGATE directive (navigate without interaction - for map transitions, ledges, etc.)
                    ...
                    # portal_wait_frames and portal_approach_direction are dict aliases from stuck_handler
                ...
                # Handle NAVIGATE_AND_INTERACT directive (most common)
                    ...
                    # Third priority: Try A* pathfinding
                        ...
                        # Additional fallback: direction-based local A* (edge of 15x15)
                ...
                # Handle DIALOGUE (press A to advance dialogue)
                    ...
                    stuck_handler._post_dialogue_movement_count = 0  # Reset counter when dialogue starts
...
"""
    ...
    # Debug: Show full VLM response
    print(f"🔍 [VLM RESPONSE] Step {actual_step} - FULL Response:")
    print("=" * 80)
    print(action_response)
    print("=" * 80)

    # Parse VLM response using dedicated parsing pipeline
